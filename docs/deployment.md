...
بیش از پنجاه مورد را بند به بند بررسی می‌کند و هرجا انجام نشده، **دستور دقیق انجامش** را
...
```bash
/opt/feranocar/deploy/preflight.sh --full   # به‌علاوه‌ی تمرین واقعی تمدید گواهی
```
