...
└── archive/                  هرچه تاریخی یا اسکلت اولیه است — ماکاپ، اسناد قدیمی، ابزارهای کم‌کاربرد.
                              اجرا و سرو نمی‌شود؛ فهرست و دلیل هر مورد در archive/README.md
```
...
| `blueprint.md` | نیازمندی اولیه‌ی فاز یک — کد به بندهایش ارجاع می‌دهد («blueprint 3.3»)؛ جاهایی با کد امروز فرق دارد |
| `../archive/` | اسکرین‌شات‌های قدیمی، ماکاپ، برنامه‌ی فنی اولیه، طراحی لاگ‌ها، ابزارهای کم‌کاربرد — `archive/README.md` |
