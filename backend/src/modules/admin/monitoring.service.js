...
const ACTION_PHRASES = {
  ...
  CAR_CREATED: 'آگهی خودرو ثبت کرد',
  CAR_UPDATED: 'آگهی خودرو را ویرایش کرد',
...
const ACTION_FAMILIES = [
  ...
  },
  {
    ...
    actions: ['HAVALE_CREATED', 'HAVALE_UPDATED', 'HAVALE_RENEWED', 'HAVALE_FULFILLED',
      ...
      'REGISTRATION_FULFILLED', 'REGISTRATION_DELETED', 'CAR_CREATED', 'CAR_UPDATED',
      'CAR_RENEWED', 'CAR_FULFILLED', 'CAR_DELETED'],
  },
  {
    key: 'REVEAL',
    label: 'نمایش مشخصات',
