const MESSAGES = {
  ...
  CAR_PRICES: {
    ITEM_NOT_FOUND: 'این خودرو در فهرست قیمت روز نیست',
    WATCH_LIMIT: 'فهرست من پر است — حداکثر {n} خودرو',
    WATCHED: 'به فهرست من اضافه شد',
    UNWATCHED: 'از فهرست من برداشته شد',
  },
  SEAT: {
  ...
  LISTING: {
    ...
    NETWORK_ONLY_NO_NETWORK:
      'گزینه‌ی «فقط شبکه‌ی من» فقط برای نمایندگی مرکزی و زیرنمایندگی‌ها در دسترس است',
