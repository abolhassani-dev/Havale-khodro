...
function catalogGrid() {
  ...
  <div class="card">
    <div class="card-h">
      <h2>کاتالوگ خودرو ${qtip('برندها و مدل‌هایی که نمایندگی‌ها موقع ثبت آگهی — در هر سه بازار — از بینشان انتخاب می‌کنند. روی هر برند بزنید تا مدل‌هایش را ببینید و ویرایش کنید. مدل استفاده‌شده حذف نمی‌شود؛ غیرفعالش کنید تا از فرم ثبت بیفتد و آگهی‌های قبلی سالم بمانند.')}</h2>
  ...
  <div class="card">
    <div class="card-h">
      <h2>رنگ‌ها ${qtip('رنگ‌هایی که در فرم‌های ثبت آگهی پیشنهاد می‌شوند. روی هر رنگ بزنید تا نام و ترتیبش را عوض کنید؛ با × غیرفعال می‌شود و از فرم ثبت می‌افتد.')}</h2>
